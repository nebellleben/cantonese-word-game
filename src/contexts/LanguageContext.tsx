...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'processingPronunciation': 'Processing your pronunciation...',
    'skipWord': 'Skip Word',
    ...
    'recordingError': 'An error occurred during recording. Please try again.',
    'recordingStartFailed': 'Failed to start recording. Please try again.',
    'microphoneAccessFailed': 'Failed to access microphone. Please check your permissions and try again.',
    'microphonePermissionDenied': 'Microphone permission was denied. Please allow microphone access in your browser settings and try again.',
    'microphoneNotFound': 'No microphone found. Please connect a microphone and try again.',
    'microphoneInUse': 'Microphone is already in use by another application. Please close other applications using the microphone and try again.',
    'microphoneConstraintsError': 'Microphone constraints could not be satisfied. Please try a different microphone.',
    'browserNotSupported': 'Your browser does not support audio recording. Please use a modern browser like Chrome, Firefox, or Safari.',
    'httpsRequired': 'Microphone access requires HTTPS. Please access this site over HTTPS or use localhost.',
    'submissionFailed': 'Failed to submit pronunciation. Please try again.',
  ...
  'zh-TW': {
    ...
    'recording': '錄音中...',
    'stopRecording': '停止錄音',
    'processingPronunciation': '正在處理您的發音...',
    'skipWord': '跳過詞彙',
    'gameComplete': '遊戲完成！',
    'finalScore': '最終分數',
    'correct': '正確',
    ...
    'recordingError': '錄音時發生錯誤。請重試。',
    'recordingStartFailed': '無法開始錄音。請重試。',
    'microphoneAccessFailed': '無法訪問麥克風。請檢查權限並重試。',
    'microphonePermissionDenied': '麥克風權限被拒絕。請在瀏覽器設置中允許麥克風訪問，然後重試。',
    'microphoneNotFound': '未找到麥克風。請連接麥克風並重試。',
    'microphoneInUse': '麥克風正被其他應用程序使用。請關閉其他使用麥克風的應用程序，然後重試。',
    'microphoneConstraintsError': '無法滿足麥克風約束條件。請嘗試使用其他麥克風。',
    'browserNotSupported': '您的瀏覽器不支持音頻錄製。請使用現代瀏覽器，如 Chrome、Firefox 或 Safari。',
    'httpsRequired': '麥克風訪問需要 HTTPS。請通過 HTTPS 訪問此網站或使用 localhost。',
    'submissionFailed': '提交發音失敗。請重試。',
